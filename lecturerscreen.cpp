...
{
    int currentSeconds = currentPresentationTime.hour() * 3600 + currentPresentationTime.minute() * 60 + currentPresentationTime.second();
    int targetSeconds = targetPresentationTime.hour() * 3600 + targetPresentationTime.minute() * 60 + targetPresentationTime.second();
